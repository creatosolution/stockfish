...
import {getLoginActivity} from "store/slices/usersSlice";
 ...
 console.log("nameValue", nameValue)
  ...
  return (
    <>
      ...
      {Array.isArray(login_logs) && login_logs.length > 0 && 
        <Card title="Users">
          <div className="table-responsive">
            <Table
              columns={logsColumns}
              dataSource={login_logs}
              rowKey='id'
              scroll={{ x: 1200 }}
...
const mapStateToProps = ({users }) => {
    ...
    const {loading, login_logs} = users;
  return {
    loading,
    login_logs
  };
...
function WithNavigate(props) {
  ...
  return <LoginActivity {...props} navigate={navigate} params={params} />
}
